...
import com.mobiera.lib.etsi102221.model.ReadBinaryCommand.Builder;

public class ActivateFileCommand extends UICCCommand {
	...
	protected int getInstructionCode() {
		return EtsiConstants.INS_ACTIVATE_FILE;
	}
	...
	public static class Builder<T extends Builder<T>> {
		...
		public Builder<T> selectMode(SelectMode value) {
		...
		public ActivateFileCommand build() throws Etsi102221Exception {
			ActivateFileCommand output = new ActivateFileCommand();
			output.fid = this.fid;
